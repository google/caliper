 ...
 */
@WorkerScoped
@Subcomponent(modules = BenchmarkModelComponent.BenchmarkModelModule.class)
public interface BenchmarkModelComponent {
  ...
  @WorkerScoped
  final class Spec extends WorkerSpec {
  ...
  final class Processor extends WorkerProcessor<BenchmarkClassModel> {
