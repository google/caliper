...
import dk.ilios.caliperx.config.InstrumentConfig;
import dk.ilios.caliperx.model.Host;
import dk.ilios.caliperx.model.Run;
import dk.ilios.caliperx.options.CaliperOptions;
import dk.ilios.caliperx.runner.Instrument.Instrumentation;
import dk.ilios.caliperx.util.InvalidCommandException;
...
final class ExperimentingRunnerModule extends AbstractModule {
  ...
  @Provides @Singleton @NanoTimeGranularity
  ShortDuration provideNanoTimeGranularity(
