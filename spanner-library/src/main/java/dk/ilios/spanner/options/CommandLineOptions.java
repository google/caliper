 ...
 */
public final class CommandLineOptions implements SpannerOptions {
...
// --------------------------------------------------------------------------
    ...
    private File spannerDirectory = new File(System.getProperty("user.home"), ".spanner");

    @CommandLineParser.Option({"--directory"})
    private void setSpannerDirectory(String path) {
        spannerDirectory = new File(path);
    }

    @Override
    public File spannerDirectory() {
        return spannerDirectory;
    }
    ...
    @Override
    public File spannerConfigFile() {
        return caliperConfigFile.or(new File(spannerDirectory, "config.properties"));
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                ...
                .add("spannerConfigFile", this.caliperConfigFile)
                .toString();
    }
