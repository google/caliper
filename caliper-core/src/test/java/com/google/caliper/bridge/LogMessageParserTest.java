...
public class LogMessageParserTest {
  ...
  @Test
  public void gcPatten_jdk7() throws Exception {
    List<String> lines =
        Resources.readLines(
  ...
  @Test
  public void gcMessageData() {
    assertEquals(
        new GcLogMessage(INCREMENTAL, ShortDuration.of(1232, MICROSECONDS)),
        parser.parse("[GC 987K->384K(62848K), 0.0012320 secs]"));
    assertEquals(
        new GcLogMessage(FULL, ShortDuration.of(5455, MICROSECONDS)),
        parser.parse("[Full GC 384K->288K(62848K), 0.0054550 secs]"));
    assertEquals(
        new GcLogMessage(INCREMENTAL, ShortDuration.of(1424, MICROSECONDS)),
        parser.parse(
            "2013-02-11T20:15:26.706-0600: 0.098: [GC 1316K->576K(62848K), 0.0014240 secs]"));
    assertEquals(
        new GcLogMessage(FULL, ShortDuration.of(4486, MICROSECONDS)),
        parser.parse(
            "2013-02-11T20:15:26.708-0600: 0.099: [Full GC 576K->486K(62848K), 0.0044860 secs]"));
  }

  @Test
  public void jitPattern_jdk6() throws Exception {
    List<String> lines =
        Resources.readLines(
  ...
  @Test
  public void jitPattern_jdk7() throws Exception {
    List<String> lines =
        Resources.readLines(
  ...
  @Test
  public void vmOptionPattern_jdk6() throws Exception {
    List<String> lines =
        Resources.readLines(
  ...
  @Test
  public void vmOptionPattern_jdk7() throws Exception {
    List<String> lines =
        Resources.readLines(
