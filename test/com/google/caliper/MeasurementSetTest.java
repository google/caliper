...
public class MeasurementSetTest extends TestCase {
  ...
  Ordering<Measurement> MEASUREMENT_BY_NANOS = new Ordering<Measurement>() {
    @Override public int compare(Measurement a, Measurement b) {
      return Double.compare(a.getNanosPerRep(), b.getNanosPerRep());
    }
  };
  ...
  public void testPlusMeasurement() {
    ...
    assertDoubleListsEquals(measurementSet2.getMeasurementNanos(),
        measurementSet3.getMeasurementNanos(), 0.0000001);
    ...
    for (int i = 0; i < measurementList1.size(); i++) {
      assertEquals(measurementList1.get(i).getNanosPerRep(),
          measurementList2.get(i).getNanosPerRep());
      assertEquals(measurementList1.get(i).getUnitsPerRep(),
          measurementList2.get(i).getUnitsPerRep());
    }
  }
  ...
  public void testMedian() {
    ...
    measurements[2] = new Measurement(ImmutableMap.of("doublens", 1), 2.3, 4.6);
    MeasurementSet measurementSet = new MeasurementSet(measurements);
    assertEquals(2.3, measurementSet.medianNanos(), 0.00000001);
    ...
    MeasurementSet measurementSet2 =
        new MeasurementSet(measurements2);
    assertEquals((2.3 + 3.8) / 2, measurementSet2.medianNanos(), 0.00000001);
  ...
  public void testMean() {
    ...
    measurements[2] = new Measurement(ImmutableMap.of("doublens", 1), 2.3, 4.6);
    MeasurementSet measurementSet = new MeasurementSet(measurements);
    assertEquals((1.1 + 3.8 + 2.3) / 3, measurementSet.meanNanos(), 0.00000001);
    ...
    MeasurementSet measurementSet2 =
        new MeasurementSet(measurements2);
    assertEquals((1.1 + 2.3 + 3.8 + 7.2) / 4, measurementSet2.meanNanos(), 0.00000001);
  ...
  public void testStandardDeviation() {
    ...
    measurements[2] = new Measurement(ImmutableMap.of("doublens", 1), 2.3, 4.6);
    MeasurementSet measurementSet = new MeasurementSet(measurements);
    assertEquals(1.35277, measurementSet.standardDeviationNanos(), 0.00001);
  ...
  public void testMax() {
    ...
    measurements[2] = new Measurement(ImmutableMap.of("doublens", 1), 2.3, 4.6);
    MeasurementSet measurementSet = new MeasurementSet(measurements);
    assertEquals(3.8, measurementSet.maxNanos(), 0.00000001);
  ...
  public void testMin() {
    ...
    measurements[2] = new Measurement(ImmutableMap.of("doublens", 1), 2.3, 4.6);
    MeasurementSet measurementSet = new MeasurementSet(measurements);
    assertEquals(1.1, measurementSet.minNanos(), 0.00000001);
  ...
  public void testJsonRoundtrip() {
    ...
    assertDoubleListsEquals(measurementSet.getMeasurementNanos(),
        roundTripped.getMeasurementNanos(), 0.00000001);
  ...
  public void testFromLegacyString() {
    ...
    assertDoubleListsEquals(Arrays.asList(122.0, 133.0, 144.0),
        measurementSet.getMeasurementNanos(), 0.00000001);
    assertDoubleListsEquals(Arrays.asList(122.0, 133.0, 144.0),
