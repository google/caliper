...
public class MalformedBenchmarksTest {
  ...
  @Test
  public void abstractBenchmark() throws Exception {
  ...
  @Test
  public void noSuitableConstructor() throws Exception {
    expectException(
        String.format(NO_CONSTRUCTOR, BadConstructorBenchmark.class.getName()),
  ...
  static class BadConstructorBenchmark {
    ...
    @Benchmark
    void timeIt(int reps) {}
  }

  @Test
  public void noBenchmarkMethods() throws Exception {
  ...
  @Test
  public void staticBenchmarkMethod() throws Exception {
  ...
  static class BoxedParamBenchmark {
    @Benchmark
    void timeIt(Integer reps) {}
  }

  @SuppressWarnings("unused")
  static class ExtraParamBenchmark {
    @Benchmark
    void timeIt(int reps, int what) {}
  }

  @Test
  public void hasBenchmarkOverloads() throws Exception {
  ...
  static class OverloadsAnnotatedBenchmark {
    @Benchmark
    public void foo(long reps) {}

    @Benchmark
    public void foo(int reps) {}

    @Benchmark
    public void bar(long reps) {}

    @Benchmark
    public void bar(int reps) {}

    @Benchmark
    public void baz(int reps) {}
  ...
  @Test
  public void staticParam() throws Exception {
  ...
  @Test
  public void reservedParameterName() throws Exception {
  ...
  @Test
  public void unparsableParamType() throws Exception {
  ...
  @Test
  public void unparsableParamDefault() throws Exception {
