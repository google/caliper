...
public final class CaliperTestWatcher extends TestWatcher {
  ...
  public CaliperTestWatcher() {}

  public CaliperTestWatcher forBenchmark(Class<?> benchmarkClass) {
    this.benchmarkClass = benchmarkClass;
    return this;
  }

  public CaliperTestWatcher instrument(String instrument) {
    this.instrument = instrument;
    return this;
  }

  public CaliperTestWatcher options(String... extraOptions) {
  ...
  public ImmutableList<Trial> trials() {
  ...
  public File workerOutputDirectory() {
    return workerOutput;
  }
}
